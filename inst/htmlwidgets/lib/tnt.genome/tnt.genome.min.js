    ...
    21: [function(t, e, n) {
        ...
        e.exports = function() {
            ...
            var x = function() {
                ...
                b = function(e) {
                    return e.g = t.select("g").select("g").append("g").attr("class", "tnt_track").attr("height", e.height()), e.g.append("rect").attr("x", 0).attr("y", 0).attr("width", v.width()).attr("height", e.height()).style("fill", e.color()).style("pointer-events", "none"), e.display() && e.display().scale(a).init.call(e, c), v
                },
                w = function(t, e) {
                    var n, r = a.domain(),
                        o = r[1] - r[0],
        ...
        var r = t("tnt.api"),
            ...
            i = function() {
                ...
                return r(n).getset(e).method({
                    ...
                    init: function(t) {
                        this.g.append("text").attr("class", "tnt_fixed").attr("x", 5).attr("y", 12).attr("font-size", 11).attr("fill", "grey").text(this.label()), e.fixed.call(this, t)
                    },
                        ...
                        i = {
                            ...
                            update: function(i) {
                              console.log("update");
                                ...
                                var a = this.g,
                                    s = t.domain();
                                void 0 === e && ((e = a).append("text").text(o(r, n, ~~s[0], ~~s[1])));
                                Shiny.onInputChange("chr", n);
                                Shiny.onInputChange("positionStart", ~~s[0]); 
                                Shiny.onInputChange("positionStop", ~~s[1]);
                            },
                            scale: function(e) {
                                return arguments.length ? (t = e, this) : t
                            },
    ...
    40: [function(t, e, n) {
        ...
        tnt_board_genome = function() {
            ...
            var t = o.track.data.genome.ensembl,
                ...
                s = o.track().height(20).color("white").data(o.track.data.empty()).display(o.track.feature.genome.location()),
